...
RW_API_KEY = os.environ.get("RW_API_KEY", "")
RW_API_BASE = os.environ.get("RW_API_BASE")
RW_MODEL_NAME = os.environ.get("RW_MODEL_NAME", "meta-llama/Llama-3.3-70B-Instruct")
