...
class EntropyScoreModel(AbstractProcessRewardModel):
    ...
    def score(
        ...
        for start_idx in range(0, len(prompts), batch_size):
            ...
            with torch.no_grad():
                ...
                scores = [[s.item()] for s in self._calculate_entropy(outputs.logits)]
    ...
    def _calculate_entropy(self, logits):
        with torch.no_grad():
            ...
            log_probs = torch.nn.functional.log_softmax(logits, dim=-1)  # (B, L-1, V)
